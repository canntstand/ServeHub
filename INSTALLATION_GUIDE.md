...
2. Git на хосте для синхронизации репозитория с GitLab CE
    ...
    3. Регистрация Runner в GitLab
    4. Добавление GitLab Runner и копирование токена в .env, после использование файла для настройки runner в контейнере
    5. Создание runner контейнера